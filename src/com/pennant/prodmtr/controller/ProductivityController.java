...
public class ProductivityController {
	...
	@Autowired
	public ProductivityController(UserService userService, SubtaskService subtaskService) {
	...
	public String getActivity(Model model, HttpSession session) {
		...
		List<Subtask> activiySubTasks = userService.getUserSubtaskActivities(user);
		List<Subtask> activiyApprovalSubTasks = subtaskService.getUnapprovedSubtasks(user);
		model.addAttribute("activityTasks", activiyTasks);
		model.addAttribute("activitySubTasks", activiySubTasks);
		model.addAttribute("activiyApprovalSubTasks", activiyApprovalSubTasks);
		return "activity";
	}
