...
public class PerformanceController {
	...
	public String getAllPerformance(Model model) {
		...
		for (UserDto resource : resources) {
			...
			totalTasks = totalTasks + totalProjectTasks;
			...
			double hoursWorked2 = projectTaskService.getHoursWorkedByUserId(resource.getUserId());
			resource.setPerformanceScore(performanceScore);

			resource.setHoursWorked(hoursWorked + hoursWorked2);
