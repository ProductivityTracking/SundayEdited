...
public class TaskInput {
	...
	public String toString() {
		return "TaskInput [taskId=" + ", taskName=" + taskName + ", taskCreationDateTime=" + taskCreationDateTime
				+ ", taskType=" + taskType + ", referencedTaskId=" + referencedTaskId + ", taskCategory=" + taskCategory
	...
	public TaskInput(Integer taskId, String taskName, String taskCreationDateTime, String taskType,
			...
			Integer taskSupervisorId, String taskRemarks, String taskStatus, short projectId, short moduleId) {
		super();
		this.taskName = taskName;
		this.taskCreationDateTime = taskCreationDateTime;
		this.taskType = taskType;
