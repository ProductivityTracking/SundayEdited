...
public class ModuleDTO {
	...
	public static ModuleDTO fromEntity(Module module) {
		...
		moduleDTO.setModl_desc(module.getModuleDescription()); 
	...
	public String toString() {
		return "ModuleDTO [modl_id=" + modl_id + ", modl_name=" + modl_name + ", modl_desc=" + modl_desc
				+ ", modl_project_id=" + modl_project_id + "]";
	}
