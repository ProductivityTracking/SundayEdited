...
//Method implementation for getting modules using projectId and  using ORM
	...
	public List<Module> getAllModules() {
		TypedQuery<Module> query = entityManager.createQuery("SELECT pt FROM Module pt ", Module.class);
