...
public class ProjectTaskdaoImpl implements ProjectTaskdao {
	...
	public int getCompletedTasksByUserId(int userId) {
		...
		String jpql = "SELECT COUNT(t) FROM ProjectTask t WHERE t.assignedUser = :user AND t.taskStatus = 'COMP'";
	...
	public double getHoursWorkedByUserId(int userId) {
		User user = findByUserId(userId);
		String jpql = "SELECT SUM(t.numberOfHoursRequired) FROM ProjectTask t WHERE t.assignedUser = :user AND t.taskStatus = 'COMP'";
