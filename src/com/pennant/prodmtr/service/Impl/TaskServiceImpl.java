...
public class TaskServiceImpl implements TaskService {
	...
	public List<TaskDto> TfilterTasks(TFilterCriteria filterCriteria) {
		// TODO Auto-generated method stub
		return taskDao.PtfilterTasks(filterCriteria);
	}
	...
	public void updateTaskStatus(TaskUpdateFormModel taskUpdateFormModel) {
		taskDao.setTaskStatus(taskUpdateFormModel.getTaskId(), taskUpdateFormModel.getRemarks(),
				taskUpdateFormModel.getStatus());
	}
