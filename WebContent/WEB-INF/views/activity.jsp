...
<body>
    ...
    <br><br>
        ...
        <table>
            <tr>
                ...
                <th>Number of Hours Req</th>
                <th>Creation Date</th>
                <th>Approval State</th>
                <!-- Add more table headers as needed -->
            </tr>

            <c:forEach items="${activiyApprovalSubTasks}" var="subtask">
    ...
    function onSubtaskRowClick(taskId, subtaskId) {
        alert("reached " + taskId + " " + subtaskId);
        var paramValue = taskId + "," + subtaskId;
        window.location.href = "setSubTaskStatus?compositeId=" + paramValue;
    }
