...
<body>
    ...
    <div class="container">
        ...
        <form action="TaskAdded" method="post">
            ...
            <input type="hidden" id="funid" name="funid" value="<%= ft != null ? ft.getFuncId() : "" %>">
             <input type="hidden" id="taskStatus" name="taskStatus" value="">
               <input type="hidden" id="taskRemarks" name="taskRemarks" value="">
				...
				<select id="taskType" name="taskType" required>
				 <option disabled selected hidden>TaskType</option>
				  ...
				  <option value="SPR">SPRN</option>
                     ...
                     <label for="taskCreatorId">Task Creater:</label>
                    <select class="form-control" id="taskCreatorId" name="taskCreatorId" >
                   ...
                   <label for="referencedTaskId">Reference Task</label>  
            ...
            <input type="datetime-local" id="taskExpectedDateTime" name="taskExpectedDateTime">
                ...
                <label for="taskSupervisorId">Task Supervisor:</label>
